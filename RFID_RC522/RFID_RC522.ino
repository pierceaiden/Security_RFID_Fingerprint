...
void setup() {
  ...
  Serial.println(F("RFID DOOR LOCK/UNLOCK"));   // For debugging purposes
  ...
  if (programMode) {
    if ( isMaster(readCard) ) { //When in program mode check First If master card scanned again to exit program mode
      ...
      if ( findID(readCard) ) { // If scanned card is known delete it
        Serial.println(F("I know this CARD, removing..."));
        deleteID(readCard);
        Serial.println("-----------------------------");
        Serial.println(F("Scan a CARD to ADD or REMOVE to EEPROM"));
      }
      else {                    // If scanned card is not known add it
        Serial.println(F("I do not know this CARD, adding..."));
        writeID(readCard);
        Serial.println(F("-----------------------------"));
        Serial.println(F("Scan a CARD to ADD or REMOVE to EEPROM"));
      }
...
///////////////////////////////////////// Get CARD's UID ///////////////////////////////////
uint8_t getID() {
  // Getting ready for Reading CARDs
...
void buzz(int buzztime){
  tone(buzzer, 3400); // Send 1KHz sound signal...
  delay(buzztime);        // ...for 1 sec
